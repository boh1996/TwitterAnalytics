...
<b>{{change_value}}</b> : The difference value in percentage<br>
<b>{{difference}}</b> : The difference between the two<br>
...
<b>{{top_category_count}}</b> : The number of hits for the top category<br>
