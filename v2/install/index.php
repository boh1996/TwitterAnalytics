...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Install | Twitter Statistics</title>
		  ...
		  <?php if(isset($message)) {echo '<p class="error">' . $message . '</p>';}?>
				...
				<form id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					<fieldset>
						...
						<label for="database">Database Name</label><input type="text" id="database" class="input_text" name="database" value="twitter_statistics" />
						<label for="port">Database port</label><input type="text" id="port" class="input_text" name="port" value="3306" />

						<hr>
						<legend>System settings</legend>
						<label for="hostname">Base URL</label><input type="text" id="base_url" class="input_text" name="base_url" value="http://127.0.0.1/tws/" />
